...
class DianaBot(commands.Bot):
    def __init__(self, description="Hello! I'm Diana, a bot made by Sparksbet to provide some utilities."):
        ...
        super().__init__(command_prefix=get_prefix, description=description, owner_id=self.config.owner_id, fetch_offline_members=True)
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=default_activity, status=discord.Status.online)
